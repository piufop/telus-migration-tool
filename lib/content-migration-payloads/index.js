        ...
        if (step.transform) {
          ...
          if (typeof clonedEntry.payload.fields[step.payload.fromId] === 'object') {
            Object.keys(clonedEntry.payload.fields[step.payload.fromId]).forEach((key) => {
              clonedEntry.payload.fields[step.payload.toId] = clonedEntry.payload.fields[step.payload.toId] || {};
            ...
            clonedEntry.payload.fields[step.payload.toId] = _.cloneDeep(step.payload.transform(clonedEntry.payload.fields[step.payload.fromId]));
          }
        }
      });
